...
# Correction of the spellings of the tweet. Takes too much time.
...
def modelselection(X, y, modelname, featureExtractionVector):
    ...
    for modelname in modelname:
        ...
        for train_index, test_index in kf.split(X, y):
            ...
            # Linear SVC does not have a prediction probability function.
            if modelname != 'SVM':
        ...
        # title = f"Learning Curves {modelname}"
        # plot_learning_curve(model, modelname, title, X_train, y_train, ylim=None)
        ...
        dictionary = dict()
        # Dictionary is returned to create a new dataframe and save it as a csv file.
